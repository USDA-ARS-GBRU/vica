...
time sketchblacklist.sh -Xmx63g in=$datadir/sorted.fa.bgzip.gz prepasses=1 tree=$TAXTREE taxa taxlevel=species ow out=blacklist_refseq_species_300.sketch mincount=300 k=19,24
